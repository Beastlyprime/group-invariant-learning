...
for METHOD in rex
do
    for SEED in 13214 54673 54324 
    do
        for ADAPT_WEIGHT in 1e-2 1e-3 1e-4
        do
            for ASCEND_RATE in 0.2 0.4 0.6
            do
                OUTPUT_FOLDER=/mnli/multi_env/train-blocking-10-dense/${METHOD}/basic_bert_lr_5_epoch_3_lambda_${ADAPT_WEIGHT}_${ASCEND_RATE}-SEED-${SEED}/
